...
- Analyzed and optimized time and space complexity
- Applied recursion and sorting/searching algorithms

#### **Discrete Mathematics**
- Studied logic, proofs, set theory, and combinatorics
- Learned about graph theory and its applications in computer science
- Applied discrete structures in algorithm analysis

#### **Simulation & Stochastic Modeling**
- Modeled systems using M/M/1 queues and discrete-event simulation
- Analyzed queueing behavior under different load conditions
- Gained hands-on experience with simulation-based experiments

#### **Operating Systems**
- Explored memory management, process scheduling, and concurrency
- Practiced using semaphores, threads, and interprocess communication
- Developed a strong foundation in system-level programming with C

#### **Foundations in Data Science & Analytics**
- Worked with data wrangling, visualization, and interpretation
- Applied basic statistical methods and predictive modeling
- Used Python and Excel to analyze real-world datasets
...
Feel free to browse my repositories — I'm regularly adding new projects from my computer science coursework and personal interests.
